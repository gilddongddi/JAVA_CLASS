...
/* 데이터 검색 면에서는 ArrayList<E> 가 현저하게 빠르고
*  데이터 추가 삭제 면에서는 LinkedList<E> 가 현저하게 빠름 */
...
public class ArrayListVsLinkedList {
    public static void main(String[] args){
        ...
        endTime = System.nanoTime();
        System.out.println("LinkedList 의 데이터 제거 시간 = " + (endTime-startTime) + " ns");
